    ...
    <section className='relative overflow-hidden bg-gray-50'>
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div aria-hidden='true' className='pointer-events-none absolute inset-0 -z-10 transform-gpu overflow-hidden blur-3xl'>
          <div className='relative left-[calc(50%-3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 opacity-20 sm:left-[calc(40%-30rem)] sm:w-[40.1875rem]'
            style={{
              clipPath:
        ...
        <div className='text-center mb-16'>
          <MotionH2 initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} transition={{duration:0.5}} className="font-bold text-xl uppercase mb-4 text-rose-500">
            How it works
          </MotionH2>
...
function StepItem({ icon, label, description }: Step) {
  return (
    <div className="relative p-6 rounded-2xl bg-white shadow-md hover:shadow-2xl transition-all group w-full h-full">
